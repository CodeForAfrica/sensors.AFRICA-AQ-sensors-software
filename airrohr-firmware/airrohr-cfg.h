...
const char CFG_KEY_GSM_READ[] PROGMEM = "gsm_read";
...
const char CFG_KEY_BASIC_AUTH_INFLUX[] PROGMEM = "basic_auth_influx";
...
static constexpr ConfigShapeEntry configShape[] PROGMEM = {
	...
	{ Config_Type_Bool, 0, FPSTR(CFG_KEY_GSM_READ), &cfg::gsm_read },
	...
	{ Config_Type_String, sizeof(cfg::basic_auth_influx)-1, FPSTR(CFG_KEY_BASIC_AUTH_INFLUX), cfg::basic_auth_influx },
